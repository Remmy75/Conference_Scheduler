...
class conference_db {
   ...
   public static function select_all() {
    ...
    public static function get_conference($conference_num) {
        ...
        $conference[$value['conference_num']] = new comment($value['conference_num'], $value['conference_name'], $value['conference_location'], $value['start_time'], $value['end_time'], $value['lunch'], $value['session_length'], $value['break_length']);
